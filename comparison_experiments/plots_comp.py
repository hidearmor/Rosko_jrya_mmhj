...
def plot_comparison(title, fname = "rosko_comp"):
	...
	# labels = ['Rosko', 'Array-Numpy, zero-rows stripped']
	labels = ['Rosko', 'CSR-Numpy']
    # algos = ['rosko', 'numpy_csr', 'numpy_arr']
	# algos = ['rosko', 'numpy_arr']
	algos = ['rosko', 'numpy_csr']
	# algos = ['rosko', 'numpy_dense']
	# sparsities = [60, 70, 80, 90, 95, 98, 99]
	# sparsities = [60, 70, 80, 90, 95, 98, 99, 99.5, 99.7, 99.9]
	sparsities = [99, 99.5, 99.8, 99.9]
	# results_fname = 'results_comp_numpy_random_sample'
	# results_fname = 'results_row-pattern_r10'
	results_fname = 'results_randomuni_numpycsr'
